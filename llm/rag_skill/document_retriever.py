...
def search_knowledge(data):
    ...
    if not data:
        ...
        exit(1)
    #D:\PycharmProject\Agent\skills\autogenstudio-skills-main\rag\knowledge
    # Initialize with the path to your index folder
    index_folder = "/Users/baihl/Downloads/00-AIAgent智能体实战课/AI智能体实战课程学习资料/04-微软AutoGen智能体/本地知识库接入-RAG/rag_skill/knowledge"
